Shader "Custom/RainbowShaderWithBorder"
{
        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            float _UnscaledTime; // New unscaled time property
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float wave = sin(gradient * 6.0 + _UnscaledTime * _WaveSpeed) * _WaveAmplitude; // Replace _Time.y with _UnscaledTime
                ...
                float borderWave = sin(i.uv.x * _BorderWaveFrequency + _UnscaledTime * _WaveSpeed) * _BorderWaveAmplitude; // Use _UnscaledTime
                borderWave += sin(i.uv.y * _BorderWaveFrequency + _UnscaledTime * _WaveSpeed) * _BorderWaveAmplitude; // Use _UnscaledTime
